...
//     {image: n1, desc: "دنیای آنلاین؛ راهی برای افزایش فروش", colSpan: true, uniqueHeight: "250px"},
//     {image: n2, desc: "بازاریابی حسی راهی ساده و کم هزینه \n برای افزایش فروش", colSpan: true, uniquniqueHeightueWidth: "250px"},
//     {image: n3, desc: "از کجا مشتری پیدا کنم؟ راه‌های پیدا کردن مشتری", colSpan: false, uniqueHeight: "200px"},
//     {image: n4, desc: "نیازهای مشتری را بشناسید تا درآمدتان بیشتر شود", colSpan: false, uniqueHeight: "200px"},
//     {image: n5, desc: "ورود به دنیای آنلاین; راهی مطمین برای \n افزایش فروش", colSpan: true, uniqueHeight: "250px"},
//     {image: n6, desc: "جذب مشتری با تبلیغات دهان به دهان", colSpan: true, uniqueHeight: "250px"}
// ]

// export const NewsApi = {
//     leftItem: [
//         {image: n1, holderId: true, pos: true, desc: "دنیای آنلاین؛ راهی برای افزایش فروش", colSpan: true, uniqueHeight: "250px"},
//         {image: n2, pos: true, desc: "بازاریابی حسی راهی ساده و کم هزینه \n برای افزایش فروش", colSpan: true, uniquniqueHeightueWidth: "250px"},
//         {image: n3, holderId: false, pos: false, desc: "از کجا مشتری پیدا کنم؟ راه‌های پیدا کردن مشتری", colSpan: false, uniqueHeight: "200px"},
//     ],
//     rightItem: [
//         {image: n4, holderId: false, pos: false, desc: "نیازهای مشتری را بشناسید تا درآمدتان بیشتر شود", colSpan: false, uniqueHeight: "200px"},
//         {image: n5, holderId: true, pos: true, desc: "ورود به دنیای آنلاین; راهی مطمین برای \n افزایش فروش", colSpan: true, uniqueHeight: "250px"},
//         {image: n6, pos: true, desc: "جذب مشتری با تبلیغات دهان به دهان", colSpan: true, uniqueHeight: "250px"}
//     ]
// }
