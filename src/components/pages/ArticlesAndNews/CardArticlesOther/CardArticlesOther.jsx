...
const CardArticlesOther = ({title,image,onClick}) => {
  return (
    <div className="w-[251px] h-[70px] relative shadow-sm rounded-r-lg rounded-l-xs cursor-pointer" data-aos="zoom-in" onClick={onClick}>
      ...
      <div className="flex flex-col gap-3">
        <div className="h-[17px] mt-2.5 mr-2.5">
          <h1 className="w-[165px] text-sm font-b-yekan font-bold text-[#006865] text-nowrap truncate" title={title}>{title}</h1>
        </div>
