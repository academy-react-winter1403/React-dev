...
//             <div className="h-[572px] w-[1202px] flex justify-between border m-auto">
//                 <div className='border w-[35%] flex flex-col font-b-yekan justify-center gap-9'>
//                     <h1 className='text-[#01CEC9] text-6xl font-normal drop-shadow-lg'>
//                         آکادمی سپهر
//                     </h1>
//                     <p className='text-[#555555] text-[20px] font-normal whitespace-nowrap leading-9'>
...
//                 <div className='border w-[50%] flex justify-center relative font-b-yekan'>
//                     <LandingCharacter/>

//                     <div className='w-[200px] h-[105px] bg-[#FFFFFF] absolute top-0 left-0 rounded-[10px] shadow-lg'>
//                         <img 
//                         className='absolute top-[-30px] left-1/2 transform -translate-x-1/2 '
//                         src={students} 
//                         alt="#" 
//                         />
//                         <p className='text-center mt-12 text-[#434343] text-[27px]'>
//                             +1000 دانشجو
//                         </p>
//                     </div>

//                     <div className='w-[200px] h-[105px] bg-[#FFFFFF] absolute bottom-9 right-0 rounded-[10px] shadow-lg'>
//                         <img 
//                         className='absolute top-[-30px] left-1/2 transform -translate-x-1/2 '
//                         src={teacher} 
//                         alt="#" 
