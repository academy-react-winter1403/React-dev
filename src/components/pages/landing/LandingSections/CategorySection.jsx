...
const CategorySection = () => {
  ...
  return (
    <div
      className="w-full h-[620px] flex flex-col items-center justify-between font-b-yekan whitespace-nowrap mt-20 max-w-[1515px] mx-auto "
      data-aos="fade-up"
    >
      {/* category title */}
      ...
      <div className="w-full h-[500px] relative">
        <CategoryBG itemTop={0} itemLeft={0}>
          <div className="h-auto w-[80%]  grid grid-cols-2 md:grid-cols-4 place-items-center lg:gap-y-[53px] md:gap-y-[61px] xs:gap-y-[53px]">
            {CategorySectionApi.map((item, index) => (
              <div
                key={index}
                className="flex flex-col items-center justify-center bg-(--category-option) rounded-3xl relative rotate-45 md:gap-10 
