...
const Themes = () => {
  ...
  const themes = [
    ...
    { key: "Light", icon: <MdColorLens className="text-amber-500" />, label: "Light" },
  ];
          ...
          <ul className="py-1">
            {themes.map((theme) => (
              <li
                ...
                className={`flex items-center px-4 py-2 text-sm cursor-pointer text-white gap-1 hover:bg-gray-100 dark:hover:bg-gray-700 ${
