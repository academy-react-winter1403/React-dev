  ...
  return (
    <div
      className={`description-box-container w-full ${
        !heightFlag ? `h-[${initialHeight}px] transition-[1s]` : `h-auto transition-[1s]`
      } relative shadow-[0_1px_2px_#00000040]
        rounded-2xl p-7 overflow-hidden`}
    >
      <div className="grodient w-full h-full absolute top-0 left-0 bg-linear-to-b from-[#FFFFFF00] to-[#FFFFFF]"></div>
      {children}
      <div className="btn-control w-full absolute bottom-[10px] left-0 flex justify-center">
        <button
          className="group bg-transparent border border-[#01CEC9] rounded-[45px] transition-colors
                py-[9px] px-[35px] flex items-center gap-x-[8px] hover:bg-[#006865]"
